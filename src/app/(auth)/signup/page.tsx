  ...
  return (
    <div className="bg-authBg flex-1 flex items-center justify-center h-screen p-1 sm:p-4">
      <Card className="w-full md:h-4/5 max-h-full max-w-lg bg-white shadow-none border-none">
        <CardContent className="px-4 sm:px-8 pt-10 sm:pt-0 sm:!py-4">
        <Image
        src={SVG.LOGO}
        alt="Logo"
      ...
      />
          <div className="text-heading text-center mb-8 text-[20px] sm:text-[24px] font-poppins">
            <h1 className="font-medium">{"Get Started With "}<span className="font-poppins text-primaryColor">Metrix</span></h1>
            <h1 className="text-[16px] text-gray-400">{"Create your free account"}</h1>
          </div>
          <div className="pt-4">
          < SignUpForm />
          </div>
